        ...
        <div class="header-body">
          ...
          <div class="row">
            <div class="col-md-7 mb-3">
              <h1 class="display-4 text-white text-uppercase" style="border-bottom: 2px solid #fff;">Update Tempat PKL siswa</h1>
            </div>            
          </div>
          
          <?php echo form_open_multipart('admin/updateTempat') ?>

            <?php foreach($tempat_siswa as $a): ?>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <div class="input-group input-group-alternative mb-4">
                    ...
                    <textarea class="form-control form-control-alternative" type="text" name="alamat" required><?php echo $a->alamat ?></textarea>
                  </div>
                </div>
              </div>
